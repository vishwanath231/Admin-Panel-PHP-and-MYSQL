...
<head>
    ...
    <link rel="stylesheet" href="assets/css/team.css? <?php echo time(); ?>">
...
<body class="overlay-scrollbar">
    ...
    <section class="user-img" style="text-align: center; margin-top:50px">
        <img src="assets/img/team.png" alt="user-image" style="width:500px;">
    </section>
